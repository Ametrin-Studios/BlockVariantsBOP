...
public final class BBRecipeProvider extends ExtendedRecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        // FLOWER PETALS
        stairSlabWall(BBBlocks.WHITE_FLOWER_PETAL_STAIRS.get(), BBBlocks.WHITE_FLOWER_PETAL_SLAB.get(), BBBlocks.WHITE_FLOWER_PETAL_WALL.get(), BOPBlocks.WHITE_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.LIGHT_GRAY_FLOWER_PETAL_STAIRS.get(), BBBlocks.LIGHT_GRAY_FLOWER_PETAL_SLAB.get(), BBBlocks.LIGHT_GRAY_FLOWER_PETAL_WALL.get(), BOPBlocks.LIGHT_GRAY_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.GRAY_FLOWER_PETAL_STAIRS.get(), BBBlocks.GRAY_FLOWER_PETAL_SLAB.get(), BBBlocks.GRAY_FLOWER_PETAL_WALL.get(), BOPBlocks.GRAY_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.BLACK_FLOWER_PETAL_STAIRS.get(), BBBlocks.BLACK_FLOWER_PETAL_SLAB.get(), BBBlocks.BLACK_FLOWER_PETAL_WALL.get(), BOPBlocks.BLACK_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.BROWN_FLOWER_PETAL_STAIRS.get(), BBBlocks.BROWN_FLOWER_PETAL_SLAB.get(), BBBlocks.BROWN_FLOWER_PETAL_WALL.get(), BOPBlocks.BROWN_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.RED_FLOWER_PETAL_STAIRS.get(), BBBlocks.RED_FLOWER_PETAL_SLAB.get(), BBBlocks.RED_FLOWER_PETAL_WALL.get(), BOPBlocks.RED_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.ORANGE_FLOWER_PETAL_STAIRS.get(), BBBlocks.ORANGE_FLOWER_PETAL_SLAB.get(), BBBlocks.ORANGE_FLOWER_PETAL_WALL.get(), BOPBlocks.ORANGE_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.YELLOW_FLOWER_PETAL_STAIRS.get(), BBBlocks.YELLOW_FLOWER_PETAL_SLAB.get(), BBBlocks.YELLOW_FLOWER_PETAL_WALL.get(), BOPBlocks.YELLOW_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.LIME_FLOWER_PETAL_STAIRS.get(), BBBlocks.LIME_FLOWER_PETAL_SLAB.get(), BBBlocks.LIME_FLOWER_PETAL_WALL.get(), BOPBlocks.LIME_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.GREEN_FLOWER_PETAL_STAIRS.get(), BBBlocks.GREEN_FLOWER_PETAL_SLAB.get(), BBBlocks.GREEN_FLOWER_PETAL_WALL.get(), BOPBlocks.GREEN_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.CYAN_FLOWER_PETAL_STAIRS.get(), BBBlocks.CYAN_FLOWER_PETAL_SLAB.get(), BBBlocks.CYAN_FLOWER_PETAL_WALL.get(), BOPBlocks.CYAN_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.LIGHT_BLUE_FLOWER_PETAL_STAIRS.get(), BBBlocks.LIGHT_BLUE_FLOWER_PETAL_SLAB.get(), BBBlocks.LIGHT_BLUE_FLOWER_PETAL_WALL.get(), BOPBlocks.LIGHT_BLUE_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.BLUE_FLOWER_PETAL_STAIRS.get(), BBBlocks.BLUE_FLOWER_PETAL_SLAB.get(), BBBlocks.BLUE_FLOWER_PETAL_WALL.get(), BOPBlocks.BLUE_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.PURPLE_FLOWER_PETAL_STAIRS.get(), BBBlocks.PURPLE_FLOWER_PETAL_SLAB.get(), BBBlocks.PURPLE_FLOWER_PETAL_WALL.get(), BOPBlocks.PURPLE_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.MAGENTA_FLOWER_PETAL_STAIRS.get(), BBBlocks.MAGENTA_FLOWER_PETAL_SLAB.get(), BBBlocks.MAGENTA_FLOWER_PETAL_WALL.get(), BOPBlocks.MAGENTA_FLOWER_PETAL_BLOCK, false);
        stairSlabWall(BBBlocks.PINK_FLOWER_PETAL_STAIRS.get(), BBBlocks.PINK_FLOWER_PETAL_SLAB.get(), BBBlocks.PINK_FLOWER_PETAL_WALL.get(), BOPBlocks.PINK_FLOWER_PETAL_BLOCK, false);
